      ...
      <div className="details-cont">
        ...
        >
          ...
          >
            ...
            selling items, detailed information/pictures about each item, create
            and save a favorite/wish list of products from different categories,
            filter products based on price range, shop the look and more.
          </p>
          <ul
            style={{
              display: "flex",
